...
namespace ai
{
    namespace paladin
    {
        ...
        public:
            ...
            {
                ShareCreators<AuraManualStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<AuraSituationStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<BlessingManualStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<BlessingSituationStrategyFactoryInternal>([this] {

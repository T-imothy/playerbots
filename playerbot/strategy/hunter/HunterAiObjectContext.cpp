...
namespace ai
{
    namespace hunter
    {
        ...
        public:
            ...
            {
                ShareCreators<StingManualStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<StingSituationStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<AspectManualStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<AspectSituationStrategyFactoryInternal>([this] {

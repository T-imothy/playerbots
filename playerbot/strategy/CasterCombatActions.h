...
namespace ai
{
    ...
    public:
        ...
        std::string GetTargetName() override
        {
            ...
            if ((spell == "cyclone" || spell == "hex") && ai->GetUnit(ai->GetAiObjectContext()->GetValue<ObjectGuid>("cc target", spell)->Get())) return "cc target";
        ...
        Unit* GetTarget() override
        {
            ...
            {
                Unit* marked = ai->GetUnit(ai->GetAiObjectContext()->GetValue<ObjectGuid>("cc target", spell)->Get());
        ...
        bool isUseful() override
        {
            ...
            if (spell == "cyclone" || spell == "hex")
            {
                ...
                if (ai->GetUnit(ai->GetAiObjectContext()->GetValue<ObjectGuid>("cc target", spell)->Get()) == target) return true;

...
namespace ai
{
    ...
    public:
        ValueContext()
        {
            ...
            creators["blackwing lair position"] = [](PlayerbotAI* ai) { return new BlackwingLairPositionValue(ai); };
            creators["naxxramas position"] = [](PlayerbotAI* ai) { return new NaxxramasPositionValue(ai); };

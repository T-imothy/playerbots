...
namespace ai
{
    namespace rogue
    {
        ...
        public:
            ...
            {
                ShareCreators<StealthSituationStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<PoisonsSituationStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<PoisonMainStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<PoisonOffStrategyFactoryInternal>([this] {
                    creators["poisons"] = [](PlayerbotAI* ai) { return new RoguePoisonsPlaceholderStrategy(ai); };

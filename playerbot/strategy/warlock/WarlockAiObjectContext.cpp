...
namespace ai
{
    namespace warlock
    {
        ...
        public:
            ...
            {
                ShareCreators<PetManualStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<PetSituationStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<CurseManualStrategyFactoryInternal>([this] {
        ...
        public:
            ...
            {
                ShareCreators<CurseSituationStrategyFactoryInternal>([this] {

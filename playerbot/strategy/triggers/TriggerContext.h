...
namespace ai
{
    ...
    public:
        TriggerContext()
        {
            ...
            creators["pull action"] = [](PlayerbotAI* ai) { return new PullActionTrigger(ai); };
            ...
            creators["karazhan priority target"] = [](PlayerbotAI* ai) { return new KarazhanPriorityTargetTrigger(ai); };

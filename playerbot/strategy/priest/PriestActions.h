...
namespace ai
{
    ...
    SPELL_ACTION_U(CastStarshardsAction, "starshards", CastSpellAction::isUseful() && (AI_VALUE2(uint8, "mana", "self target") > 50 && ai->GetUnit(AI_VALUE(ObjectGuid, "current target")) && AI_VALUE2(float, "distance", "current target") > 15.0f));

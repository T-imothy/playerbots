...
bool PlayerbotAIConfig::Initialize()
{
    ...
    transportTeleportType = config.GetIntDefault("AiPlayerbot.TransportTeleportType", 1);
    ...
    randomBotAllianceCount = config.GetIntDefault("AiPlayerbot.RandomBotAllianceCount", 0);
    randomBotHordeCount = config.GetIntDefault("AiPlayerbot.RandomBotHordeCount", 0);
    ...
    chatDirectorPartyPostArrivalErrandGraceSeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyPostArrivalErrandGraceSeconds", 30);
    chatDirectorPartyLocalServiceRadiusYards = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyLocalServiceRadiusYards", 600);
    chatDirectorPartyCriticalBagUsagePercent = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyCriticalBagUsagePercent", 90);
    chatDirectorPartyTaskActiveDeadlineSeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyTaskActiveDeadlineSeconds", 45);
    chatDirectorPartyBundleActiveDeadlineSeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyBundleActiveDeadlineSeconds", 120);
    chatDirectorPartyBundleWallDeadlineSeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyBundleWallDeadlineSeconds", 180);
    chatDirectorPartyTaskRouteAttempts = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyTaskRouteAttempts", 2);
    chatDirectorPartyTaskOperationAttempts = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyTaskOperationAttempts", 2);
    chatDirectorPartyErrandCooldownSeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorPartyErrandCooldownSeconds", 600);
    ...
    chatDirectorSharedActivitySeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorSharedActivitySeconds", 60);
    chatDirectorSharedActivityWindowSeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorSharedActivityWindowSeconds", 120);
    ...
    chatDirectorRecoveryNoProgressSeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorRecoveryNoProgressSeconds", 900);
    chatDirectorRecoveryFailureBackoffSeconds = config.GetIntDefault("AiPlayerbot.ChatDirectorRecoveryFailureBackoffSeconds", 1800);

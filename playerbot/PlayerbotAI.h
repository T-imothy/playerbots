...
public:    
    ...
    // Execute inline on the world owner or this bot's map. Foreign-map work uses
    // the existing bounded WorldActions queue, drained after map workers join.
    // The queue validates the actor lifetime; resolve the target GUID at dispatch.

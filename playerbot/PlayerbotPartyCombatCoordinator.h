...
namespace ai
{
    ...
    private:
        ...
        std::string ApplySpecialization(Player* member, const std::string& specialization,
            const std::string& mode, uint32 partySessionId) const;
        ...
        mutable std::map<uint32, uint32> lastPartyLootScan;

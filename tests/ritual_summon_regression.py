...
int main(){using namespace ai;
 ...
 reset();ritualInfo.Id=11206;warlock.mapId=70;assert(hold.isUseful()&&hold.Execute(event));
 active.state=SPELL_STATE_FINISHED;assert(!hold.isUseful());
 reset();ritualInfo.Id=11206;warlock.mapId=1;assert(!hold.isUseful());
